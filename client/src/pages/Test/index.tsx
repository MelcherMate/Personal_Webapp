...
const layouts = {
  ...
  3: ["div1"],
  4: ["div1", "div2", "div3", "div4", "div5", "div6", "div7"],
};
...
const layoutsContent: Record<number, Record<string, JSX.Element | string>> = {
  ...
  2: {
    div1: <span className="mateMelcher">Welcome</span>,
    div2: (
      <span className="intorductionText">
        Hi, I'm Máté Melcher. I'm an engineer passionate about technology,
        programming, and macroeconomics. I believe engineering isn't just about
        invention—it's about creating solutions that improve lives and make
        economic sense. After working a year as an economist at a multinational
        company, I realized how much I missed engineering. Now, I'm studying
        Environmental, Process & Energy Engineering at MCI Innsbruck, focusing
